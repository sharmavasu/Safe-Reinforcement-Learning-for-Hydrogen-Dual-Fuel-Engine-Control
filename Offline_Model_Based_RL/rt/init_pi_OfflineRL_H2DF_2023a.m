...
LowerLimit = ([0.17e-3;350;-1;1.5e-3] - C2C_NMPC.Normalization.controls.mean)./(C2C_NMPC.Normalization.controls.std);

UpperLimit= ([0.5e-3;900;-0.5;5.5e-3] - C2C_NMPC.Normalization.controls.mean)./(C2C_NMPC.Normalization.controls.std);
LowerLimit = ([0.17e-3;800;-1;2e-3] - C2C_NMPC.Normalization.controls.mean)./(C2C_NMPC.Normalization.controls.std);

UpperLimit= ([0.5e-3;900;10;5.5e-3] - C2C_NMPC.Normalization.controls.mean)./(C2C_NMPC.Normalization.controls.std);
LowerLimit = ([0.17e-3;350;-2;2e-3] - C2C_NMPC.Normalization.controls.mean)./(C2C_NMPC.Normalization.controls.std); 

% UpperLimit= ([0.5e-3;450;0;5.5e-3] - C2C_NMPC.Normalization.controls.mean)./(C2C_NMPC.Normalization.controls.std);
% LowerLimit = ([0.17e-3;380;-1;1e-3] - C2C_NMPC.Normalization.controls.mean)./(C2C_NMPC.Normalization.controls.std);
